...
public class BlockOfSkyMod {
    ...
    public static final RegistrySupplier<Item> VOID_BLOCK_ITEM = ITEMS.register(void_block, () -> new BlockItem(VOID_BLOCK.get(), new Item.Properties().arch$tab(CreativeModeTabs.FUNCTIONAL_BLOCKS)));
